...
# base_dir = '../SABS-CT-MICCAI2015/sabs_CT_normalized'
base_dir = '../CHAOST2test/chaos_MR_T2_normalized'
...
n_sv = 5000
# n_sv = 1000
if ~os.path.exists(f'../CHAOST2test/supervoxels_{n_sv}/'):
    os.mkdir(f'../CHAOST2test/supervoxels_{n_sv}/')
# if ~os.path.exists(f'../SABS-CT-MICCAI2015/supervoxels_{n_sv}/'):
#     os.mkdir(f'../SABS-CT-MICCAI2015/supervoxels_{n_sv}/')
...
for img_path in imgs:
    ...
    # seg_fid = os.path.join(f'../SABS-CT-MICCAI2015/supervoxels_{n_sv}/', f'superpix-{MODE}_{idx}.nii.gz')
    # seg_fid = os.path.join(f'../CHAOST2test/supervoxels_{n_sv}/', f'superpix-{MODE}_{idx}.nii.gz')
